...
function addProductToCard(event) {
  ...
  newCard.innerHTML = `
             <td>
              <img src="${productImage}" class="cart-product-img ms-1" style="height: 2em;width: 2em;" alt="coxinha">
            ...
            <td>
              <input class="cart-input intput-mini text-center" type="number" value="1" min="0" placeholder='quantas?' 
                id='intput-mini-coxinha' style="width: 5em;">
              </input>
            </td>
            <td>
...
// function formatarTextoParaAPI(texto) {
//   // Remover caracteres especiais e substituir espaços por "%20"
//   const textoFormatado = texto.replace(/[^\w\s]/gi, '').replace(/\s/g, espaco).replace(/\n/g, outraLinha);
...
// var textoOriginal = 'Olá! Obrigado por entrar em contato! Como posso ajudar?' + " "
// const textoFormatado = formatarTextoParaAPI(textoOriginal);
